...
export default function Login() {
  ...
  useEffect(() => {
    ...
    const loadTimer = setTimeout(() => setPageLoading(false), 500);
      ...
      {pageLoading ? (
        ...
        <div className="min-h-screen flex">
          ...
          <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-12">
            ...
            >
              <div className="w-48 h-48 rounded-full bg-primary flex items-center justify-center mx-auto mb-8">
                <img src="/cloudvault_logo.png" alt="CloudVault Logo" className="w-full h-full object-contain rounded-full" />
              </div>
